...
INSERT INTO tarifa (tipo_vehiculo, precio_hora, fecha_vigencia_inicio, estado) VALUES 
('Sedan', 5.00, NOW(), 'En vigencia'),
('SUV', 7.00, NOW(), 'En vigencia'),
('Compacto', 4.00, NOW(), 'En vigencia'),
('Moto', 2.50, NOW(), 'En vigencia'),
('Camioneta', 8.00, NOW(), 'En vigencia');

-- 4. Generar espacios de parqueo (4 zonas x 10 espacios = 40 espacios)
INSERT INTO espacio (codigo, letra_espacio, estado)
SELECT 
    CONCAT(letter, '-', LPAD(number, 2, '0')),
    letter, 
    'libre'
FROM (
